...
?>" class="card-img-top" alt="' .
      ...
      '"></a>
            ...
            <div class="card-body bg-dark col-8 p-0 row">
              ...
              if (isset($_SESSION['rights']) && $_SESSION['rights'] == 2) { ?>
                ...
                <button type="button" class="btn-close btn-danger btn-sm" aria-label="Close" data-bs-toggle="modal" data-bs-target="#suppression<?= $altId ?>"></button>
                </div>
    <?php }
              ?>
                <div class="modal fade popup" id="suppression<?= $altId ?>" tabindex="-1" aria-labelledby="suppressionLabel" aria-hidden="true">
                    ...
                    <div class="modal-header">
                      ...
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        ...
                        <div class="modal-footer">
                          ...
                          <a type="button" class="btn btn-danger" href="verifications/verifActivity.php?delete=<?= $altId ?>">Supprimer</a>
                        </div>
                    </div>
                  </div>
                </div>
    ...
    <?php for ($j = 0; $j < $countCategory; $j++) {
      ...
      <?php
              ...
              <p class="fs-6 mb-0 col">Durée de l'activité : <i class="bi bi-clock" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Durée de l'activité"></i> <?= $activity[
                'duration'
      ...
      <?= $activity[
        'priceAttendee'
               ...
               | Nombre maximum de participants : <i class="bi bi-people" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Nombre maximum de participants"></i><?= $activity[
                 'maxAttendee'
               ] ?></p>
    </div>
    ...
    for ($k = 0; $k < 7; $k++) {
      if (in_array($dayOfWeek[$k], array_column($day, 'day'))) { ?>
        <div class="card bg-primary text-white col mx-1 p-0 fs-6 text-center">
          <div class="card-body px-2 py-1"><?= $frenchDay[$k] ?></div>
        </div>
        <?php $j++;} else { ?>
        <div class="card bg-secondary text-white col mx-1 p-0 fs-6 text-center">
          <div class="card-body px-2 py-1"><?= $frenchDay[$k] ?></div>
        </div>
      <?php }
    }
