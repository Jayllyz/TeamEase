...
<body>
    ...
    <main>
        <div class="container">
            ...
            <form action="verifications/verifActivity.php" method="post" id="activity-form"
        ...
        <div class="row mb-3">
            <input type="checkbox" class="btn btn-check" id="<?= $fetch[$i] ?>" name="category[]"
                value="<?= $fetch[$i] ?>" autocomplete="off">
            <label class="btn btn-outline-success col me-2 mb-3" for="<?= $fetch[$i] ?>">
                <?= $fetch[$i] ?>
            </label>
            <?php } else { ?>
            <input type="checkbox" class="btn btn-check" id="<?= $fetch[$i] ?>" name="category[]"
            ...
            <div class="row">
                <div class="col">
                    <label for="duration">
                        <h4>Durée de l'activité (en minute)</h4>
                    </label>
            ...
            <div class="mb-4 my-3">
                ...
                <div>
                    <button type="button" class="btn btn-primary" onclick="assignProvider()">Ajouter un
                        prestataire</button>
                </div>
            </div>
            <div class="mb-4 my-3">
                ...
                <div>
                    <button type="button" class="btn btn-primary" onclick="assignMaterial()">Ajouter du
                        matériel</button>
                </div>
            </div>
            <div class="mb-4 my-3">
                ...
                <div class="row mb-4 my-3">
                    ...
                    <label class="btn btn-outline-success col mx-2" for="monday"
                        onclick="selectedDay('monday')">Lundi</label>
                    <input type="checkbox" name="day[]" class="btn-check" id="tuesday" value="tuesday"
                        autocomplete="off">
                    <label class="btn btn-outline-success col mx-2" for="tuesday"
                        onclick="selectedDay('tuesday')">Mardi</label>
                    <input type="checkbox" name="day[]" class="btn-check" id="wednesday" value="wednesday"
                        autocomplete="off">
                    <label class="btn btn-outline-success col mx-2" for="wednesday"
                        onclick="selectedDay('wednesday')">Mercredi</label>
                    <input type="checkbox" name="day[]" class="btn-check" id="thursday" value="thursday"
                        autocomplete="off">
                    <label class="btn btn-outline-success col mx-2" for="thursday"
                        onclick="selectedDay('thursday')">Jeudi</label>
                    <input type="checkbox" name="day[]" class="btn-check" id="friday" value="friday" autocomplete="off">
                    <label class="btn btn-outline-success col mx-2" for="friday"
                        onclick="selectedDay('friday')">Vendredi</label>
                    <input type="checkbox" name="day[]" class="btn-check" id="saturday" value="saturday"
                        autocomplete="off">
                    <label class="btn btn-outline-success col mx-2" for="saturday"
                        onclick="selectedDay('saturday')">Samedi</label>
                    <input type="checkbox" name="day[]" class="btn-check" id="sunday" value="sunday" autocomplete="off">
                    <label class="btn btn-outline-success col mx-2" for="sunday"
                        onclick="selectedDay('sunday')">Dimanche</label>
                </div>
                <div class="row">
                    <div class="col-4 my-3" style="display:none" id="mondayHour">
                        <label class="my-2">
                            <h5>Horaires de Lundi</h5>
                        </label>
                        <div class="row">
                            <div class="col-5">
            ...
            <div class="mb-4 my-3">
                ...
                <div>
                    ...
                    ?>
                    <button type="button" class="btn btn-secondary dropdown-toggle mx-2" id="" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Sites
                    </button>
