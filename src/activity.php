...
<body onload="populateComment(<?= $activity['id'] ?>)">
    ...
    <main>
        <div class="container mb-5 text-center">
            ...
            <div id="showcase" class="carousel slide" data-bs-ride="carousel" data-interval="5000">
                <div class="carousel-indicators">
                    <button type="button" data-bs-target="#showcase" data-bs-slide-to="0" class="active"
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="container col-md-8" id="comment-container">
                </div>
            </div>
        </div>

        <!-- Modal edition description -->
        <div class="modal fade popup" id="edition-description" tabindex="-1" aria-labelledby="editionLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="verifications/verifActivity.php?update=description&id=<?php echo $id; ?>"
  ...
  echo 'checked';
        ...
        <div class="modal fade popup" id="edition-details" tabindex="-1" aria-labelledby="editionLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="verifications/verifActivity.php?update=details&id=<?php echo $id; ?>"
                            method="post" id="activity-form" enctype="multipart/form-data">
                            <div class="form-group mb-3">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-primary" onclick="assignProvider()">Ajouter
                                            un prestataire</button>
                                    </div>
                                </div>
                                <div class="mb-4">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-primary" onclick="assignMaterial()">Ajouter
                                            du matériel</button>
                                    </div>
                                </div>
                                <div class="mb-4">
                                    ...
                                    <div>
                                        ...
                                        ?>
                                        <button type="button" class="btn btn-secondary dropdown-toggle mx-2" id=""
                                        ...
                                        ?>
                                        <button type="button" class="btn btn-secondary dropdown-toggle mx-2" id="room"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            <?= $roomName ?>
                                        </button>
                                        <ul class="dropdown-menu">
                                    ...
                                    <input id="roomInput" name="room" type="number" value="<?= $roomId ?>"
                                        style="display:none">
                                </div>
                            </div>
                            <div class="modal-footer">
        ...
        <div class="modal fade popup" id="edition-category" tabindex="-1" aria-labelledby="editionLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="verifications/verifActivity.php?update=category&id=<?php echo $id; ?>"
                            method="post" enctype="multipart/form-data">
                            <div class="form-group mb-3">
                                <?php
