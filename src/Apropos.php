                ...
                <div class="row">
                    <div class="col">
                        ...
                        <p class="text-center lh-sm fs-4">
                            Chez TeamEase, nous sommes passionnés par la création d'expériences de teambuilding
                            efficaces pour les entreprises de toutes tailles et de tous secteurs.
                            Nous proposons une large gamme d'activités de teambuilding personnalisées pour
                            améliorer la communication, la collaboration et l'efficacité de votre équipe.
                            Contactez-nous dès maintenant pour planifier votre prochain événement de
                            teambuilding avec TeamEase.
                        </p>
                    </div>
                </div>
