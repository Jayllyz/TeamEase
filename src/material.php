                            ...
                            <tr>
                                <th scope="row">
                                    ...
                                    <button type="button" class="btn btn-secondary dropdown-toggle"
                                        data-bs-toggle="dropdown" aria-expanded="false" id="<?php echo $material[
                                          'id'
                                        ]; ?>">
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary"
                                        onclick="updateAllocatedMaterial(this)">Modifer</button>
                                    <button type="button" class="btn btn-danger"
                                        onclick="unallocateMaterial(this)">Supprimer</button>
                                </td>
                            </tr>
                            <?php }
                            ?>
            ...
            <div>
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">
                                <input type="text" class="form-control" id="name" value="<?= $material['type'] ?>">
                            </th>
                            <td>
                            ...
                            <td>
                                <input type="number" class="form-control" id="used" value="<?= $used ?>" disabled>
                            </td>
                            <td>
                                <input type="number" class="form-control" id="available" value="<?= $available ?>"
                                    disabled>
                            </td>
                            <td>
                                <button type="button" class="btn btn-primary" data-material-id="<?= $material['id'] ?>"
                                    onclick="updateMaterial(this, <?= $material['id'] ?>)">Modifer</button>
                                <button type="button" class="btn btn-danger" data-material-id="<?= $material['id'] ?>"
                                    onclick="deleteMaterial(this, <?= $material['id'] ?>)">Supprimer</button>
                            </td>
                        </tr>
                        <?php
                        }
                ...
                <div class="d-flex justify-content-center">
                    <button type="button" class="btn btn-primary" onclick="addMaterial(this)">Ajouter du
                        matériel</button>
                </div>
            </div>
            <?php } ?>
