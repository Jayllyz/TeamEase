    ...
    <div class="row">
        ...
        <div class="col-12 col-md-9">
            ...
            <div class="row">
                <?php
                if (isset($_SESSION['siret'])) {
                  echo '<a class="btn btn-secondary col col-2 mx-3 mt-3 lang-reservations" href="/clients/reservations.php">Mes reservations</a>';
                } elseif (!isset($_SESSION['id'])) {
                  echo '<a class="btn btn-secondary col col-2 mx-3 mt-3 lang-login" href="/login.php">Se connecter</a>';
                }
                if (isset($_SESSION['siret']) || isset($_SESSION['id'])) {
                  echo '<a class="btn btn-secondary col col-2 mx-3 mt-3 lang-logout" href="/logout.php">Se deconnecter</a>';
                  echo '<a class="btn btn-secondary col col-2 mx-3 mt-3 lang-profile" href="/profile.php">Mon profil</a>';
                } else {
                  echo '<a class="btn btn-secondary col col-2 mx-3 mt-3 lang-register" href="/signin.php">S\'inscrire</a>';
                }
                if ($cartNotEmpty) {
                  echo '<a class="btn btn-secondary col col-2 mx-3 mt-3 lang-cart" href="/cart/cart.php">Mon panier</a>';
                }
                ?> </div>
        </div>
    </div>
