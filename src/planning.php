            ...
            <div class="container section-about-us border border-2 border-secondary rounded">
                <div class="container rounded align-text-bottom">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <?php
                            echo '<h5 class="row align-items-center">' . 'Nom de la salle : ' . $animates[$b]['name'] . '<br>' . $locationzone[0]['name'] . ' <br> ' .'Addresse : '  . $locationzone[0]['address'] . '</h5>';
                             ?>
                        </div>
                    </div>
                </div>
              ...
              $sql = 'SELECT * FROM RESERVATION WHERE id_activity IN (SELECT id_activity FROM ACTIVITY WHERE id_room = :id_room)';
              $stmt = $db->prepare($sql);
                      ...
                      for ($j = 0; $j < count($reservations); $j++) {
                        ...
                        for ($k = 0; $k < count($reservations); $k++) {
                            ...
                            if (
                                ...
                                $reservations[$k]['time'] == $reservations[$j]['time'] && $reservations[$k]['id'] == $reservations[$j]['id'] && $activity[0]['id_room'] == $animatees[$b]['id']
                            ) {
